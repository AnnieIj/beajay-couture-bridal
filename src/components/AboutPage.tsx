    ...
    <main id="about-page" className="min-h-screen bg-[#FCFAF7] text-[#141312] pt-24 sm:pt-28 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5]">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-6 text-sm sm:text-base text-neutral-700 font-light leading-relaxed text-left sm:text-justify">
            <p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-6">
            ...
            <p className="text-sm sm:text-base text-neutral-700 font-light leading-relaxed text-left sm:text-justify">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5]">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="p-8 sm:p-10 bg-[#F8F5EE] border border-[#DDD4C1] space-y-4">
            ...
            <p className="text-xs sm:text-sm text-neutral-700 font-light leading-relaxed text-left sm:text-justify">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5]">
        <div className="space-y-12">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <div className="w-12 h-[2px] bg-[#C59B3F] mx-auto" />
            <p className="text-sm text-neutral-700 font-light leading-relaxed text-left sm:text-justify">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5]">
        <div className="bg-[#F8F5EE] border border-[#DDD4C1] p-8 sm:p-12 lg:p-16">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-sm sm:text-base text-neutral-800 font-light leading-relaxed text-left sm:text-justify">
