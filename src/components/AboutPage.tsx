...
export const AboutPage: React.FC<AboutPageProps> = ({
  ...
  return (
    <main id="about-page" className="min-h-screen bg-[#FCFAF7] dark:bg-[#0C0C0B] text-[#141312] dark:text-[#E8E3D8] pt-24 sm:pt-28 pb-20 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-6">
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[11px] uppercase tracking-widest text-neutral-500 dark:text-[#A39D93] font-medium">
          ...
          <span>/</span>
          <span className="text-[#141312] dark:text-[#F8F5EE]">About BEAJAY</span>
        </nav>
      </div>

      {/* 1. EDITORIAL OPENING / HERO SECTION */}
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-[#111111] dark:text-[#F8F5EE] font-normal leading-[1.12] tracking-tight">
              ...
              <span className="italic font-light text-[#856122] dark:text-[#E6C875]">Global Vision.</span>
            </h1>
            ...
            <div className="p-5 sm:p-6 bg-[#F8F4EC] dark:bg-[#161514] border-l-2 border-[#C59B3F] max-w-xl">
              <p className="font-serif text-base sm:text-lg text-[#111111] dark:text-[#F8F5EE] font-normal italic">
                “Crafted in Nigeria. Made for Brides Everywhere.”
              </p>
              <p className="text-[11px] tracking-wider text-neutral-600 dark:text-[#A39D93] uppercase font-sans mt-1.5 font-medium">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              <button
                ...
                className="min-h-[44px] inline-flex items-center justify-center px-6 sm:px-7 py-3 bg-[#111111] dark:bg-[#C59B3F] hover:bg-[#2A2824] dark:hover:bg-[#B3892F] text-white dark:text-[#0C0C0B] text-xs font-semibold tracking-[0.2em] uppercase transition-colors cursor-pointer shadow-sm"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-[3/4] max-w-md mx-auto overflow-hidden bg-[#ECE6D9] dark:bg-[#1C1B19] shadow-xl border border-[#DDD4C1] dark:border-white/10">
              <img
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            <span className="text-[10.5px] tracking-[0.28em] font-semibold text-[#856122] dark:text-[#E6C875] uppercase block">
              THE CREATIVE FORCE
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#111111] dark:text-[#F8F5EE] font-normal tracking-tight">
              Meet Okiemute Beauty
            </h2>
            <div className="w-12 h-[2px] bg-[#C59B3F] mx-auto mt-2" />
            <p className="text-xs uppercase tracking-[0.22em] text-[#856122] dark:text-[#E6C875] font-medium pt-1">
          ...
          <div className="space-y-6 text-sm sm:text-base text-neutral-700 dark:text-[#D4CEC3] font-light leading-relaxed text-left sm:text-justify">
            ...
            <p>
              The original name, <strong className="font-medium text-neutral-900 dark:text-[#F8F5EE]">BJ Couture</strong>, came from the combination of Beauty and Jessica, Beauty’s husband’s sister and her roommate during school. Created during the early days of her fashion journey, the name was officially registered around 2019.
            </p>
            <p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="relative aspect-[3/4] max-w-md mx-auto overflow-hidden bg-[#ECE6D9] dark:bg-[#1C1B19] border border-[#DDD4C1] dark:border-white/10 shadow-lg">
              <img
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-6">
            <div className="space-y-2">
              ...
              <h2 className="font-serif text-2xl sm:text-4xl text-[#111111] dark:text-[#F8F5EE] font-normal leading-tight">
                Starting Again.
              </h2>
            </div>
            ...
            <div className="p-4 bg-white dark:bg-[#161514] border border-[#E8E2D4] dark:border-white/10 text-xs text-neutral-700 dark:text-[#D4CEC3] font-light italic leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4 text-center">
            ...
            <h2 className="font-serif text-2xl sm:text-4xl lg:text-5xl text-[#111111] dark:text-[#F8F5EE] font-normal leading-tight">
          ...
          <div className="p-8 sm:p-10 bg-[#F8F5EE] dark:bg-[#161514] border border-[#DDD4C1] dark:border-white/10 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#111111] dark:bg-[#C59B3F] text-[#E6C875] dark:text-[#0C0C0B] flex items-center justify-center text-xs font-serif shrink-0">
                ✦
              </div>
              <div>
                <span className="text-[10px] uppercase tracking-[0.24em] text-[#856122] dark:text-[#E6C875] font-semibold block">
                  AN IMPORTANT MILESTONE
                </span>
                <h3 className="font-serif text-lg sm:text-xl text-[#111111] dark:text-[#F8F5EE] font-normal">
      ...
      <section className="bg-[#111111] dark:bg-[#121110] border-y border-transparent dark:border-white/10 text-white py-20 sm:py-26 px-4 sm:px-6 lg:px-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-3">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#111111] dark:text-[#F8F5EE] font-normal leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pt-4">
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 space-y-2">
              <span className="text-[10px] uppercase font-mono tracking-widest text-[#856122] dark:text-[#E6C875] block">01 / TEXTILE</span>
              <h3 className="font-serif text-base text-[#111111] dark:text-[#F8F5EE]">Curated Fabric & Lace</h3>
            ...
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 space-y-2">
              <span className="text-[10px] uppercase font-mono tracking-widest text-[#856122] dark:text-[#E6C875] block">02 / BALANCE</span>
              <h3 className="font-serif text-base text-[#111111] dark:text-[#F8F5EE]">Silhouette & Structure</h3>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light leading-relaxed">
            ...
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 space-y-2">
              <span className="text-[10px] uppercase font-mono tracking-widest text-[#856122] dark:text-[#E6C875] block">03 / ARTISTRY</span>
              <h3 className="font-serif text-base text-[#111111] dark:text-[#F8F5EE]">Refined Hand Finishing</h3>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-3">
            ...
            <div className="w-12 h-[2px] bg-[#C59B3F] mx-auto" />
            <p className="text-base sm:text-lg font-serif italic text-neutral-800 dark:text-[#D4CEC3] max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 text-center space-y-2">
              <span className="font-serif text-xl sm:text-2xl text-[#856122] dark:text-[#E6C875] block font-light">Welcomed</span>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light">
                An atmosphere of warmth, respect, and attentive hospitality.
              </p>
            </div>

            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 text-center space-y-2">
              <span className="font-serif text-xl sm:text-2xl text-[#856122] dark:text-[#E6C875] block font-light">Heard</span>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light">
            ...
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 text-center space-y-2">
              <span className="font-serif text-xl sm:text-2xl text-[#856122] dark:text-[#E6C875] block font-light">Beautiful</span>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light">
            ...
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 text-center space-y-2">
              <span className="font-serif text-xl sm:text-2xl text-[#856122] dark:text-[#E6C875] block font-light">Confident</span>
              <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="space-y-12">
          ...
          <div className="max-w-2xl mx-auto text-center pt-2">
            <p className="text-xs text-neutral-600 dark:text-[#D4CEC3] font-light leading-relaxed italic">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="bg-[#F8F5EE] dark:bg-[#161514] border border-[#DDD4C1] dark:border-white/10 p-8 sm:p-12 lg:p-16">
          <div className="max-w-4xl mx-auto space-y-6">
            
            <div className="inline-flex items-center gap-2 text-xs font-semibold tracking-[0.24em] uppercase text-[#856122] dark:text-[#E6C875]">
            ...
            <blockquote className="p-5 bg-white dark:bg-[#22201E] border-l-2 border-[#C59B3F] font-serif text-base sm:text-lg italic text-[#111111] dark:text-[#F8F5EE]">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <button
                onClick={onOpenAppointment}
                className="min-h-[44px] inline-flex items-center justify-center px-7 py-3 bg-[#111111] dark:bg-[#C59B3F] hover:bg-[#2A2824] dark:hover:bg-[#B3892F] text-white dark:text-[#0C0C0B] text-xs font-semibold tracking-[0.2em] uppercase transition-colors cursor-pointer shadow-sm"
              >
                <span>BOOK AN APPOINTMENT</span>
              </button>
              ...
              <a
                ...
                className="min-h-[44px] inline-flex items-center gap-2 px-6 py-3 border border-[#856122] dark:border-[#E6C875] hover:bg-white dark:hover:bg-[#22201E] text-[#141312] dark:text-[#F8F5EE] text-xs font-semibold tracking-[0.18em] uppercase transition-colors"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#EAE3D5] dark:border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-6 bg-white dark:bg-[#161514] border border-[#E5DFD1] dark:border-white/10 space-y-2">
              <p className="font-serif text-lg sm:text-xl text-[#111111] dark:text-[#F8F5EE] font-normal italic">
                “The dream is bigger than gowns.”
              </p>
              <p className="font-serif text-lg sm:text-xl text-[#856122] dark:text-[#E6C875] font-normal italic">
                “It is about building a legacy.”
              </p>
              <p className="text-xs uppercase tracking-[0.24em] text-neutral-500 dark:text-[#A39D93] font-sans pt-1">
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-[3/4] max-w-md mx-auto overflow-hidden bg-[#ECE6D9] dark:bg-[#1C1B19] border border-[#DDD4C1] dark:border-white/10 shadow-xl">
              <img
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-3">
            ...
            <h2 className="font-serif text-3xl sm:text-5xl text-[#111111] dark:text-[#F8F5EE] font-normal leading-tight">
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            <button
              onClick={onOpenAppointment}
              className="min-h-[44px] inline-flex items-center justify-center px-8 py-3.5 bg-[#111111] dark:bg-[#C59B3F] hover:bg-[#2A2824] dark:hover:bg-[#B3892F] text-white dark:text-[#0C0C0B] text-xs font-semibold tracking-[0.22em] uppercase transition-colors cursor-pointer shadow-md"
            >
              <span>BOOK AN APPOINTMENT</span>
            </button>
            ...
            <button
              onClick={onNavigateCollections}
              className="min-h-[44px] inline-flex items-center justify-center px-8 py-3.5 border border-[#856122] dark:border-[#E6C875] hover:bg-[#F2EDE2] dark:hover:bg-[#22201E] text-[#141312] dark:text-[#F8F5EE] text-xs font-semibold tracking-[0.22em] uppercase transition-colors cursor-pointer"
            >
              <span>EXPLORE COLLECTIONS</span>
            </button>
            ...
            <button
              ...
              className="min-h-[44px] inline-flex items-center justify-center px-8 py-3.5 bg-white dark:bg-[#161514] border border-[#DDD4C1] dark:border-white/10 hover:bg-[#F8F5EE] dark:hover:bg-[#22201E] text-[#141312] dark:text-[#F8F5EE] text-xs font-semibold tracking-[0.22em] uppercase transition-colors cursor-pointer"
            >
          ...
          {/* Quick links */}
          <div className="pt-8 border-t border-[#EAE3D5] dark:border-white/10 flex flex-wrap items-center justify-center gap-6 text-[11px] uppercase tracking-widest text-neutral-500 dark:text-[#A39D93] font-medium">
            <button onClick={onNavigateGallery} className="hover:text-[#856122] dark:hover:text-[#E6C875] transition-colors cursor-pointer">
              Bridal Gallery
            </button>
            <span>•</span>
            <button onClick={onNavigateContact} className="hover:text-[#856122] dark:hover:text-[#E6C875] transition-colors cursor-pointer">
              Contact Us
            </button>
            <span>•</span>
            <a 
